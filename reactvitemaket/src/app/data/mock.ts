...
export const OFFICIAL_SOURCES: Source[] = [
  ...
  { id: "source-minzdrav", title: "Министерство здравоохранения Республики Беларусь", url: "https://minzdrav.gov.by/", type: "ministry", description: "Официальная информация по административным медицинским процедурам, справкам и прикреплению к поликлиникам.", lastChecked: "2026-06-08" },
  { id: "source-raschet-erip", title: "ЕРИП", url: "https://raschet.by/", type: "government_portal", description: "Официальная информация по платежам, ЖКУ и сервисам АИС «Расчёт».", lastChecked: "2026-06-08" },
  { id: "source-egr", title: "Единый государственный регистр ЮЛ и ИП", url: "https://egr.gov.by/", type: "registry", description: "Официальные сведения по регистрации юридических лиц и индивидуальных предпринимателей.", lastChecked: "2026-06-08" },
  { id: "source-nces", title: "Национальный центр электронных услуг", url: "https://nces.by/", type: "government_portal", description: "Официальная информация по электронным услугам и средствам электронной цифровой подписи.", lastChecked: "2026-06-08" },
  { id: "source-115", title: "Портал 115.бел", url: "https://115.xn--90ais/", type: "government_portal", description: "Официальный сервис обращений по вопросам ЖКХ и городского хозяйства.", lastChecked: "2026-06-08" },
  { id: "source-beltechosmotr", title: "РУП «Белтехосмотр»", url: "https://gto.by/", type: "registry", description: "Официальная информация по техническому осмотру транспортных средств.", lastChecked: "2026-06-08" },
  { id: "source-president", title: "Официальный портал Президента Республики Беларусь", url: "https://president.gov.by/", type: "government_portal", description: "Официальные сообщения, указы и распоряжения Президента Республики Беларусь.", lastChecked: "2026-06-08" },
  { id: "source-government", title: "Совет Министров Республики Беларусь", url: "https://www.government.by/", type: "government_portal", description: "Официальные постановления и новости Правительства Республики Беларусь.", lastChecked: "2026-06-08" },
];
