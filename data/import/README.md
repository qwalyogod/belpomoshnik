...
| `content_extremist_materials_2022_2026.json` | юридически чувствительный раздел, `published` только для записей с прямым официальным source URL |
...
режим для чувствительных записей. Для раздела «Экстремистские материалы»
допускается `published`, если запись содержит прямой официальный `source_url`
и не распространяет запрещённый материал. Проверка структуры не заменяет
редакторскую проверку фактов по официальным источникам.
